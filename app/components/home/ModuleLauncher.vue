...
const modules = [
  ...
  {
    title: 'CRM',
    description: 'Relacion comercial y seguimiento de clientes.',
  ...
  {
    title: 'Business',
    description: 'Procesos operativos y tableros ejecutivos.',
  ...
  {
    title: 'Admin',
    description: 'Configuraciones globales y control del sistema.',
  ...
  {
    title: 'Cobranza',
    description: 'Cartera, recuperacion y compromisos de pago.',
  ...
  {
    title: 'Credito',
    description: 'Evaluacion financiera y lineas aprobadas.',
  ...
  {
    title: 'Tax',
    description: 'Gestiones tributarias y obligaciones fiscales.',
  ...
  {
    title: 'Mail',
    description: 'Bandejas internas y flujos de comunicacion.',
    icon: 'i-lucide-mail',
    status: 'Proximamente',
  ...
  {
    title: 'Court',
    description: 'Casos, expedientes y seguimiento legal.',
    icon: 'i-lucide-scales',
    status: 'Proximamente',
    accent: 'from-stone-500/15 to-gray-500/5',
  },
  {
    title: 'Media',
    description: 'Activos audiovisuales y campanas internas.',
    icon: 'i-lucide-play-circle',
    status: 'Proximamente',
    accent: 'from-indigo-500/15 to-sky-500/5',
  },
  {
    title: 'RRHH',
